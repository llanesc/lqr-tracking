...
// mass / inertia
const double mQ = 0.70;         // mass of quadcopter [ kg ]
const double Thxxyy = 0;   // moment of inertia around x,y [ kg*m^2 ]
const double Thzz = 0;        // moment of inertia around z [ kg*m^2 ]
const double arm_len = 0;    // length of quadcopter arm [ m ]
